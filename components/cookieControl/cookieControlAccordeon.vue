<template>
  <div class="cookie-control-accordeon container" :class="[expand && 'cookie-control-accordeon--expand']">
    <template v-for="type in ['necessary', 'optional']">
      <ul v-for="c in cookies[type]" :key="c.name" class="cookie-control-accordeon__section row">
